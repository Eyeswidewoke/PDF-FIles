---
source_image: "legal-filing+court-document+scanned-document+affidavit__EFTA01453175_20260130_p001_i001.png"
source_pdf: "EFTA01453175.pdf"
method: pdf_text
words: 543
confidence: 1.00
extracted: 2026-02-13T17:07:47.118983
---
...
(a) 
If the remedial steps described in Section 1.4 above have not been completed in time, it 
...
(b) 
For the purposes of any determination pursuant to Section 6(e) the Agreement, Deemed 
...
it will be deemed that Client is a non-financial counterparty to which mandatory 
...
result and 'oss" will apply in relation to the relevant Affected Transaction(s). 
(c) 
Without prejudice to the rights, powers, remedies and privileges provided by law, neither 
...
1.6 
FC Representation. Client ID IS I rin IS NOT a Financial Counterparty. Client represents to DB 
(which representation is deemed repeated as of the time of each Swap Transaction Event) that: 
(a) 
It is either: (X) organized or incorporated inside the European union and is a financial 
...
mitigation techniques for OTC derivative transactions set out in Article 11(1Xb) of EMIR, as 
...
2.1 
the references to "swaps" in Section 6.3 of the Addendum and in Part 7 of the Dodd-Frank 
