---
source_image: "scanned-document+affidavit+court-document+legal-filing__EFTA01282752_20260130_p042_i001.png"
source_pdf: "EFTA01282752.pdf"
method: pdf_text
words: 588
confidence: 1.00
extracted: 2026-02-13T17:18:10.141882
---

(m) 
referring to Party A and Party B. 
Masser Representations. 
The representations set forth in Section 3(aXii)-(iv) are hereby 
...
(n) 
(A) Eligible Contract Participant Representation. (i) Party A represents to Party B on and as 
of the date hereof and on each date on which a Transaction is entered into between them that (a) it 
is a "swap dealer" as defined in Section la(49) of the Commodity Exchange Act, as amended 
("CEA") and Commodity Futures Trading Commission ("CFTC") Regulation 1.3(ggg) and (b) it 
is an "eligible contract participant" within the meaning of Section 1 gi8XAXv)(1) of the CEA and 
...
participant" within the meaning of Section 1 a(18XA)5(i)of the CEA and CFTC Regulation 
...
or will (a) adhere to the ISDA August 2012 DE Protocol Agreement, published by International 
...
df.protocoladb.com together with the related Answer Sheet in excel format and in such 
...
the "Questionnaires") to Party A by email to df.protocol®db.com together with the related 
...
Designated Q1Rs or Designated Fiduciaries is identified in the August 2012 DF Protocol 
Questionnaire, each such Designated Evaluation Agent, Designated QIR or Designated Fiduciary, 
as the case may be, must countersign the August 2012 DE Protocol Questionnaire where required 
and submit it to Party A using ISDA Amend or send the August 2012 DF Protocol Questionnaire 
via email to df.protocol@db.com.
