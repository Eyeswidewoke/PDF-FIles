---
source_image: "affidavit+court-document+legal-filing+scanned-document__EFTA01459399_20260130_p001_i001.png"
source_pdf: "EFTA01459399.pdf"
method: pdf_text
words: 638
confidence: 1.00
extracted: 2026-02-13T16:09:35.124458
---

Deutsche Asset 
& Wealth Management 
Account Agreement 
Gratitude/PArnerica, LTD. 
Clientlel 
Ufa i 00 Poet 0Q" SaLe, 'MAIL 
Sui 
Address 
1. 
(A....a-s. 
...
State 
kip Cods 
AOCeuet Tine (Complete if different from the Cart stow) 
Account Numbered 
...
as 'OBSIg). It includes the terms and conditions and is the contract that controls each brokerage account in which Client 
has an interest leach an *Account-I. Client agrees to read this Account Agreement and the Appendix to this Account 
...
b. For all accounts: la) no one except the person(s) named on the Account(s), or, if signed in a representative 
...
undertaken through Client's Account(s). Id) Client acknowledges that the purchase and sale of securities entails 
substantial economic risk, and represents knowingly and willingly that Client can assume such risk and le) Client 
has read and understands the terms set forth in this Account Agreement and those agreements or supplements 
incorporated by reference end understands that Client is bound by such terms; 
...
The following terms end conditions govern Client's Accountls): 
1. Rights of DBSI. All rights granted to DBSI under this Account Agreement are granted with the understanding that it 
shall be within the sole discretion of ()BSI whether, and in what manner, to exercise such rights. The failure of DBSI 
...
2. Cash Account. OBS' will classify each Account as a cash brokerage account. DBSI must separately approve the 
